...
const validarCrearVehiculo = [
  ...
  body("color")
    ...
    .withMessage("El color debe tener entre 3 y 50 caracteres"),

  body("capacidadPasajeros")
    .notEmpty()
    .withMessage("La capacidad de pasajeros es obligatoria")
    .isInt({ min: 1 })
  ...
  body("entidadId")
    ...
    .isInt({ min: 1 })
    .withMessage("La entidad debe ser un número entero positivo"),
