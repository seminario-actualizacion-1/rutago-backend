...
const validarCrearPerfilPasajero = [
  ...
  body("direccion")
    ...
    .trim()
    .isLength({ max: 300 })
    .withMessage("La dirección no debe exceder 300 caracteres"),

  body("tipoDocumentoId")
    .optional({ values: "null" })
    .isInt({ min: 1 })
    .withMessage("El tipo de documento debe ser un número entero positivo"),
  ...
  body("fechaNacimiento")
    ...
    .isISO8601()
    .withMessage(
      "La fecha de nacimiento debe tener formato ISO8601 (YYYY-MM-DD)",
    ),
